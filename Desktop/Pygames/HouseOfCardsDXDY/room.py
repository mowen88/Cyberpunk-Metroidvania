...
from tile import Tile, Coin, Platform, TrickPlatform, TrickPlatform2, TrickPlatform3, AnimatedTile, Interact, CollisionTile, Spike, CutsceneCollider, \
...
class Room(State):
	def __init__(self, game):
		...
		self.lever_sprites = pygame.sprite.GroupSingle()
		self.trick_platform = pygame.sprite.GroupSingle()
		self.trick_platform_2 = pygame.sprite.GroupSingle()
					...
					if col != '-1':
						...
						if style == 'platforms':
							if col == '0':
								...
								self.trick_platform.add(sprite)
							if col == '1':
								sprite = TrickPlatform2(self.game, self, (x, y), [self.visible_sprites, self.active_sprites], 'img/trick_platform')
								self.trick_platform_2.add(sprite)
							if col == '2':
	...
	def render(self, display):
		...
		self.run_fade()	
		# top debug messages
		self.game.draw_text(self.display_surf, str(self.player.moving_up_on_platform), ((255,255,255)), 100, (self.game.screen.get_width()*0.33,140))
		self.game.draw_text(display, str(self.player.moving_down_on_platform), ((255,255,255)), 100, (self.game.screen.get_width()*0.66,140))
